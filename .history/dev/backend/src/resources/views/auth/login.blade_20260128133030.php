        ...
        <div class="racing-card">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="input-group">
                    <input id="email" class="input-racing" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Identificación (Email)">
                ...
                <div class="input-group">
                    <input id="password" class="input-racing" type="password" name="password" required autocomplete="current-password" placeholder="Código de Acceso">
                    <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="form-links">
                    ...
                    @endif
                    <a href="{{ route('register') }}" style="color: var(--color-acento); font-weight:bold;">Crear Cuenta</a>
                </div>
            </form>
        </div>
    </div>
