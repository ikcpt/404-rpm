                    ...
                    <section class="contenido-perfil">
                        ...
                        <div class="garage-grid">
                            ...
                            <div class="coche-card"
                                style="{{ $car->status == 'reserved' ? 'border: 2px solid #ffc107;' : '' }}">
                                ...
                                <div class="coche-body" style="padding: 15px;">
                                    <div
                                        ...
                                        <h3 style="margin:0; font-size: 1.1rem;">{{ $car->brand->name }}
                                            {{ $car->model }}</h3>
                                    ...
                                    <div class="specs-row"
                                        ...
                                        <span><i class="fa-solid fa-road"></i>
                                            {{ number_format($car->km, 0, ',', '.') }} km</span>
                                    </div>

                                    <div class="coche-actions" style="display: flex; gap: 10px;">
                                        @if($car->status == 'reserved')
                                        <form action="{{ route('coche.finalizar', $car->id) }}" method="POST"
                                            style="flex:1;">
                                            @csrf
                        ...
                        <div
                            ...
                            <p style="color: #999; margin-bottom: 25px;">Explora nuestro concesionario y encuentra tu
                                máquina ideal.</p>
